...
<style scoped>
 #detailContrainer{position: absolute;left: 0;top: 0;z-index: 100;min-height:100%;width: 100%;background: white;}
 #detailContrainer.slide-enter-active{ animation:.4s slideMove;}
  @keyframes slideMove{
